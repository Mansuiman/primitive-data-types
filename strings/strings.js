...
//
////////////////////// YOUR CODE BELOW THIS LINE ///////////////////////
console.log(typeof getMyDataType);
...
let stringContainsIgnoreCase = new RegExp(subStringIgnoreCase, "i").test(mainStringIgnoreCase);
...
//
////////////////////// YOUR CODE BELOW THIS LINE ///////////////////////
testString2 = testString2.toLowerCase().replace("first sentence.", "second best,");
